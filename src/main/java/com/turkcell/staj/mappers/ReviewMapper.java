...
public interface ReviewMapper {
    ...
    ResponseGetAllOfferReviewDTO reviewToResponseGetAllDto(Review review);

    List<ResponseGetAllOfferReviewDTO> reviewsToResponseGetAllDtoList(List<Review> reviews);
}
